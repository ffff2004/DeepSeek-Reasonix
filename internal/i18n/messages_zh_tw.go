...
`,
	...
	CapabilityApprovalTitle:          "⛓ 沙箱能力擴展請求",
	CapabilityCmdLabel:               "命令:",
	CapabilityExecLabel:              "可執行:",
	CapabilityNetworkLabel:           "網路:",
	CapabilityReadPathsLabel:         "讀取路徑:",
	CapabilityWritePathsLabel:        "寫入路徑:",
	CapabilityDevicesLabel:           "裝置:",
	CapabilityBackgroundLabel:        "後台:",
	CapabilityReusableLabel:          "可複用:",
	CapabilityPreserveProcessesLabel: "行程保留:",
	CapabilityYes:                    "是",
	CapabilityNo:                     "否",
	CapabilityFullAccess:             "完整存取",
	CapabilityModelJustification:     "模型理由 (不可信):",
	CapabilityWarningPrefix:          "⚠",
	CapabilityRiskCriticalPrefix:     "⚠ 嚴重風險",
	CapabilityAllowOnce:              "允許一次",
	CapabilityAllowSession:           "允許本次對話",
	CapabilityAllowPersistent:        "允許此專案",
	CapabilityRunSandboxed:           "在原始沙箱中執行",
	CapabilityCancelCommand:          "取消命令",
	CapabilityNavHint:                "↑/↓ 選擇 · Enter 確認",
	CapabilityBgWarningFmt:           "⚠ 此授權允許保留後台行程，它們可能會在對話結束後繼續執行。",
	CapabilityFileLabel:              "檔案",
	CapabilityDirLabel:               "目錄",

	// YOLO project expansion acknowledgement
	YOLOAckTitle:          "⚠ 沙箱能力自動審批",
	YOLOAckPromptFmt:      "專案配置在工作區 %s 啟用了自動沙箱能力審批。是否確認？",
	YOLOAckAccept:         "接受",
	YOLOAckRefuse:         "拒絕",
	YOLOAckNavHint:        "↑/↓ 選擇 · Enter 確認",
	YOLOAckBlockingNotice: "需要操作：確認沙箱能力擴展以繼續。",
