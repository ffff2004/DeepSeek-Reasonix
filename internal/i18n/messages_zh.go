...
var Chinese = Messages{
	...
	CapabilityApprovalTitle:          "⛓ 沙箱能力扩展请求",
	CapabilityCmdLabel:               "命令:",
	CapabilityExecLabel:              "可执行:",
	CapabilityNetworkLabel:           "网络:",
	CapabilityReadPathsLabel:         "读取路径:",
	CapabilityWritePathsLabel:        "写入路径:",
	CapabilityDevicesLabel:           "设备:",
	CapabilityBackgroundLabel:        "后台:",
	CapabilityReusableLabel:          "可复用:",
	CapabilityPreserveProcessesLabel: "进程保留:",
	CapabilityYes:                    "是",
	CapabilityNo:                     "否",
	CapabilityFullAccess:             "完整访问",
	CapabilityModelJustification:     "模型理由 (不可信):",
	CapabilityWarningPrefix:          "⚠",
	CapabilityRiskCriticalPrefix:     "⚠ 严重风险",
	CapabilityAllowOnce:              "允许一次",
	CapabilityAllowSession:           "允许本次会话",
	CapabilityAllowPersistent:        "允许此项目",
	CapabilityRunSandboxed:           "在原始沙箱中运行",
	CapabilityCancelCommand:          "取消命令",
	CapabilityNavHint:                "↑/↓ 选择 · Enter 确认",
	CapabilityBgWarningFmt:           "⚠ 此授权允许保留后台进程，它们可能会在会话结束后继续运行。",
	CapabilityFileLabel:              "文件",
	CapabilityDirLabel:               "目录",

	// YOLO project expansion acknowledgement
	YOLOAckTitle:          "⚠ 沙箱能力自动审批",
	YOLOAckPromptFmt:      "项目配置在工作区 %s 启用了自动沙箱能力审批。是否确认？",
	YOLOAckAccept:         "接受",
	YOLOAckRefuse:         "拒绝",
	YOLOAckNavHint:        "↑/↓ 选择 · Enter 确认",
	YOLOAckBlockingNotice: "需要操作：确认沙箱能力扩展以继续。",
