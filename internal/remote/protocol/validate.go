...
var enumTypes = map[reflect.Type][]string{
	...
	reflect.TypeOf(PromptDecision("")):             values(DecisionAllowOnce, DecisionAllowSession, DecisionAllowPersistent, DecisionDeny, DecisionRunSandboxed, DecisionCancelCommand),
	reflect.TypeOf(PromptKind("")):                 values(PromptApproval, PromptAsk, PromptCapabilityApproval),
